...
**Status:** Rejected
**Decision:** Rejected after solid interview; final feedback received 2026-06-01.
...
| Tracker note | Rejected after solid interview; feedback: selected candidates had first Head of Engineering experience in successful infrastructure startups. Keep warm; JP wants to stay in touch. |
...
- Outcome update: interview completed; no news for more than 3 weeks, then closure email sent 2026-05-31.
- Final reply 2026-06-01: JP apologized for the delay and said the interview was solid, but Pipekit moved forward with candidates who had experience as the first Head of Engineering hire in successful infrastructure startups.
- Relationship note: JP said he would be interested in working together in the future if Pipekit continues to grow, sent a LinkedIn connection request, and wants to stay in touch.

## D2) Feedback Signal

**Signal extracted:** For early-stage infrastructure startup Head of Engineering roles, the missing proof point is not general engineering leadership. It is "first Head of Engineering hire in a successful infrastructure startup."

**How to adapt future positioning**

- Lead earlier with small-team/early-stage operating examples: Bazzile CTO/CPO, SCRYPT focused transformation, Pictet platform work, and direct founder/CPTO collaboration.
- Make the "first HoE hire" gap explicit if asked: the candidate has built and reorganized teams, but has not held the exact first-HoE-in-infra-startup pattern.
- For infrastructure startups, compensate by emphasizing open-source/platform credibility, customer-facing infra delivery, founder support, hiring systems, and operating-model design.
- Keep Pipekit warm: this was not a poor interview; it was a narrower pattern-match decision.
