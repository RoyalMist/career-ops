...
En tant que Responsable Data Transformation & AI CoE, tu es l’un des piliers de la transformation Data et AI du Groupe Mutuel. Ton rôle est double : orchestrer la transformation transverse de nos départements Data afin de garantir une coordination et des synergies alignées avec nos ambitions, et piloter le Center of Excellence (CoE) IA. Tu agis en véritable facilitateur pour lever les barrières technologiques et humaines, en veillant à ce que nos ambitions en data et en intelligence artificielle se traduisent par des résultats concrets et mesurables. Intéressé/e ? Postule et fais-toi connaître de nos spécialistes en recrutement.
TA MISSION

    Afin de garantir une coordination fluide et de maximiser les synergies, tu orchestres la transformation transverse des départements Data
    Tu assures l’alignement entre les initiatives Data, les enjeux métiers et les objectifs stratégiques du Groupe
    Tu pilotes et fais évoluer le Center of Excellence (CoE) AI mis en place, en développant un portefeuille de cas d’usage à forte valeur ajoutée avec les métiers
    Pour faire avancer les projets clés, tu soutiens la priorisation, l’arbitrage et la sécurisation des ressources nécessaires (humaines, techniques, budgétaires)
    Véritable relais de transformation, tu accompagnes la montée en maturité de l’entreprise sur l’IA en diffusant la vision et en soutenant le changement
    Enfin, tu mesures la valeur des initiatives Data & AI, assures un reporting clair à la direction et contribues à la prise de décision stratégique

Tes qualités

    Profil hybride, tu es capable d’évoluer aussi bien avec des interlocuteurs business qu’avec des équipes techniques
    Grâce à ton leadership d’influence, tu sais embarquer des équipes transverses sans lien hiérarchique direct
    À l’aise dans des environnements complexes, tu pilotes des projets Data & AI impliquant des enjeux stratégiques et techniques
    Doté d’une forte capacité d’analyse, tu sais exploiter des KPIs complexes et vulgariser des sujets techniques auprès de la direction
    Curieux et en veille permanente, tu t’intéresses activement aux évolutions de l’écosystème IA et données
    Structuré et rigoureux, tu assures un cadre clair et fais avancer les projets avec méthode
    Tu maîtrises le français et l’anglais (C1)

Ton expérience

    Tu disposes d’un diplôme d’ingénieur/e, d’une école de commerce ou d’un Master spécialisé en Data/IA, ou d’une expérience jugée équivalente
    En justifiant d’au moins 6 ans d’expérience en conseil ou en rôle de Lead PMO dans un environnement technologique, tu pilotes des initiatives complexes avec une exécution structurée
    Avec une bonne compréhension des environnements Cloud (Azure, AWS ou GCP) et d’outils comme Databricks ou Fabric, tu échanges efficacement avec les équipes techniques
    Parce que tu as déjà mené des projets complexes impliquant des modèles de Machine Learning ou de l’IA générative, tu accompagnes le passage de l’expérimentation à l’industrialisation

Pour nous rejoindre

    Partage-nous ton vécu avec ton CV

Fonction : Responsable Data Transformation & AI Center of Excellence N08
...
Formations continues, à l'interne comme à l'externe.
Evolution
...
Conditions sociales d'une grande entreprise.
```
